...
function RegisterPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegisterPage.useEffect": ()=>{
            const unsubscribe = auth.onAuthStateChanged({
                "RegisterPage.useEffect.unsubscribe": (user)=>{
                    if (user) {
                        ...
                        if (firestore) {
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDocumentNonBlocking"])(userDocRef, userProfile, {
                                merge: true
                            });
                        }
                        router.push('/');
            ...
            }["RegisterPage.useEffect.unsubscribe"], {
                "RegisterPage.useEffect.unsubscribe": (error)=>{
                    toast({
    ...
    const onSubmit = (data)=>{
        startTransition(()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, data.email, data.password);
        });
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center justify-center min-h-[calc(100vh-8rem)] bg-background px-4 py-12",
...
_s(RegisterPage, "JS1RG7/DQPYaPyOG5mXhU6KL92c=", false, function() {
    return [
...
//# sourceMappingURL=src_89c14063._.js.map